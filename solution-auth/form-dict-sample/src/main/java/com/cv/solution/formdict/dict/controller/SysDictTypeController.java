...
public class SysDictTypeController {
     ...
     **/
    @PostMapping("/add")
    public Result<Long> add(@RequestBody @Validated SysDictTypeAddOrEditParam param) {
     ...
     **/
    @PostMapping("/edit")
    public Result<Long> edit(@RequestBody @Validated SysDictTypeAddOrEditParam param) {
